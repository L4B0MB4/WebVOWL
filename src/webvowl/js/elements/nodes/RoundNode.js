...
module.exports = (function () {
  var o = function (graph) {
    ...
    this.toggleFocus = function () {
      ...
      if (that.nodeElement()) that.nodeElement().select("circle").classed("focused", that.focused());
    ...
    this.drawCollapsingButton = function () {
      ...
      collapsingGroupElement.append("line").attr("x1", 13).attr("y1", 12).attr("x2", 27).attr("y2", 12);
